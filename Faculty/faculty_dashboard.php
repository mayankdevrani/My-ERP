        ...
        <div class="col-6 col-md-4 row_left">
            ...
            <table class="table_details">
                <tr class="color_second">
                    <th class="table_text_left">Faculty ID :</th>
                    <td>&nbsp <?php echo $data['faculty_id'];?></td>
                </tr>
                <tr class="color_first">
                    <th class="table_text_left">Name :</th>
                    <td>&nbsp <?php echo $data['faculty_name'];?></td>
                </tr>
                <tr class="color_second">
                    <th class="table_text_left">Username :</th>
                    <td>&nbsp <?php echo $data['faculty_username'];?></td>
                </tr>
                <tr class="color_first">
                    <th class="table_text_left">Email :</th>
                    <td>&nbsp <?php echo $data['faculty_email'];?></td>
                </tr>
                <tr class="color_second">
                ...
                <tr class="color_first">
                    <th class="table_text_left">Date of Joining :</th>
                    <td>&nbsp <?php echo $data['date_of_joining'];?></td>
                </tr>
            </table>
        </div>
            ...
            <div class="col-12 col-md-12 row_right_two row_right_common">
                <div class="card" style="height:100%;width:90% ;">
                    <img class="card-img-top avatar_image"
                        ...
                        <h4 class="card-title" style="margin-top:2%;"> <?php echo $data['faculty_name']; ?> </h4>
